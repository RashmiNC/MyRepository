def ai_number_guesser():
    ...
    low = int(input(f"What should be the lowest number I can guess? "))
    ...
    while low <= high:
        ...
        if feedback == 'c' :
            print(f"🎉 Hurray!! Guessed correctly")
            break
        elif feedback == 'h' :
            low = guess + 1
    ...
    if low > high:
        print(f"🤔 Hmm, something went wrong. Are you sure you followed the rules?")
